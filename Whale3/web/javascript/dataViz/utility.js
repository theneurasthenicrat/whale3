...
function updateUtilityChart(data, labels, svg, maxWidth, maxHeight, margin, colorTab) {
...
utilityViz = {
    ...
    "initFunction": utilityScoring,
    "updateFunction": utilityScoring,
    "description": utilityDescription,
    "shortDescription": utilityShortDescription
};

graphs.positiveNegative[graphs.positiveNegative.length] = utilityViz;
graphs.numbers[graphs.numbers.length] = utilityViz;
